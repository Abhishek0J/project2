           ...
           <ul>
             ...
             <li class="list-group-item" >
               <select class="form-control" onchange="filter_park()" id="city">
                 <option value="Mombasa">Vijayawada</option>
               </select>
             </li>
             ...
             <li class="list-group-item">
               <select class="form-control" onchange="filter_park()" id="street">
                 ...
                 <option value="Tudor">Benz circle</option>
                 <option value="Kizingo">Krishna nagar</option>
                 <option value="Tononoka">Labbipet</option>
               </select>
             </li>
